...
- **Version 1.0** is online since **12 years** (circa 2013), hosted on **Hostpapa**. It remains the current public-facing site.
- **Version 2.0** is the version in this repository — developed **locally on WAMP** (`C:\wamp64\www\Soloplugs`). Target launch: **spring 2026**.
- **No CMS** — SOLOPLUGS does **not** use WordPress or any other CMS. Everything is hand-coded in plain PHP/HTML/CSS/JS.
- All development and testing happen **locally** before deployment.
