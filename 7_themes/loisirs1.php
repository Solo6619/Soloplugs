    ...
    <div class="container">
      ...
      <div class="category-grid">
        ...
        <div class="category-card category-card-image">
           <div class="category-card category-card-image">
          <div class="category-image">
            <img src="<?php echo $basePath; ?>images/sorties-loisirs-rencontres/loisirs-mouvement_01.png" alt="Créativité — loisirs solo">
          </div>
        </div>
        ...
        <div class="category-card category-card-image">
           <div class="category-card category-card-image">
          <div class="category-image">
            <img src="<?php echo $basePath; ?>images/sorties-loisirs-rencontres/loisirs-apprentissage_01" alt="Créativité — loisirs solo">
          </div>
        </div>
        ...
        <div class="category-card category-card-image">
           <div class="category-card category-card-image">
          <div class="category-image">
            <img src="<?php echo $basePath; ?>images/sorties-loisirs-rencontres/loisirs-bien-etre_01" alt="Créativité — loisirs solo">
          </div>
        </div>
