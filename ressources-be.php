...
<head>
  ...
  <meta name="description" content="Trouve les ressources adaptées à ta situation en Belgique. Écoute, soutien, aide — sans jugement.">
...
<header class="hero-compact">
  <h1>Ressources <span class="accent">Belgique</span></h1>
    ...
    sections: [
      {
        ...
        items: [
          ...
          { nom: "La Première — Et dieu dans tout ça", desc: "Réflexions philosophiques", lien: "https://www.rtbf.be/lapremiere/emissions/detail_et-dieu-dans-tout-ca", icon: "lecture" }
        ]
      },
      {
      ...
      },
      {
        ...
        items: [
          { nom: "Ligue des familles", desc: "Activités et rencontres", lien: "https://www.liguedesfamilles.be", icon: "communaute" },
          { nom: "Volontariat.be", desc: "S'engager bénévolement", lien: "https://www.volontariat.be", icon: "communaute" }
        ]
      }
    ],
    ...
    sections: [
      {
        ...
        items: [
          ...
          { nom: "Centre de Prévention du Suicide", numero: "0800 32 123", desc: "Écoute gratuite 24/7", lien: "tel:080032123", icon: "ecoute" },
      ...
      },
      {
        ...
        items: [
          { nom: "Écoute Enfants", numero: "103", desc: "Pour les moins de 18 ans — Gratuit", lien: "tel:103", icon: "ecoute" },
          { nom: "Chat de Télé-Accueil", desc: "Discussion en ligne", lien: "https://www.chat-accueil.be", icon: "ecoute" },
          { nom: "AMO — Aide en Milieu Ouvert", desc: "Accompagnement jeunes", lien: "https://www.aidealajeunesse.cfwb.be", icon: "communaute" }
        ]
      },
      {
        titre: "👴 Pour les aînés",
        items: [
          { nom: "Espace Seniors", desc: "Accompagnement des aînés", lien: "https://www.espace-seniors.be", icon: "communaute" },
          { nom: "Énéo", desc: "Mouvement social des aînés", lien: "https://www.eneo.be", icon: "communaute" }
        ]
      },
      {
        titre: "🌿 Ressources communautaires",
        items: [
          { nom: "Maisons médicales", desc: "Soins de santé accessibles", lien: "https://www.maisonmedicale.org", icon: "sante" },
          { nom: "Centres de santé mentale", desc: "Accompagnement psychologique", lien: "https://www.lfrb.be", icon: "sante" }
        ]
      }
    ],
    ...
    sections: [
      {
        ...
        items: [
          ...
          { nom: "Télé-Accueil", numero: "107", desc: "Écoute 24h/24 — Anonyme", lien: "tel:107", icon: "urgence" },
          { nom: "Zelfmoordlijn (NL)", numero: "1813", desc: "Néerlandophone — 24/7", lien: "tel:1813", icon: "urgence" }
        ]
      },
      {
        titre: "🩺 Urgences médicales",
        items: [
          { nom: "Urgences européennes", numero: "112", desc: "Urgence médicale", lien: "tel:112", icon: "sante" },
          { nom: "Aide médicale urgente", numero: "100", desc: "Ambulance / Pompiers", lien: "tel:100", icon: "sante" },
          { nom: "Médecin de garde", numero: "1733", desc: "Soins non urgents soirs/weekends", lien: "tel:1733", icon: "sante" }
        ]
      },
      {
        titre: "👦 Pour les jeunes",
        items: [
          ...
          { nom: "Child Focus", numero: "116 000", desc: "Enfants disparus / en danger", lien: "tel:116000", icon: "ecoute" }
        ]
      },
      {
        ...
        items: [
          ...
          { nom: "Écoute violences conjugales", numero: "0800 30 030", desc: "Gratuit et anonyme", lien: "tel:0800030030", icon: "ecoute" },
          { nom: "Arc-en-ciel Wallonie", desc: "Soutien LGBTQI+", lien: "https://www.arcenciel-wallonie.be", icon: "communaute" }
        ]
      }
    ],
...
function afficherResultats() {
  const data = ressourcesBelgique[etatChoisi];
