...
<nav class="nav">
  ...
  <ul class="nav-links">
    <li><a href="<?php echo $basePath ?? ''; ?><?php echo $themeRessources ?? 'ressources/ressources.php'; ?>">Ressources</a></li>
    <li class="has-submenu">
      <a href="#" class="submenu-trigger" onclick="toggleSubmenu(event, this)">Les 7 univers <span class="submenu-arrow">›</span></a>
      <ul class="submenu">
