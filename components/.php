<?php
/**
 * Widget S♡lo - Version 2 - Accueil bienveillant
...
<!-- Widget S♡lo V2 - Accueil bienveillant -->
<style>
/* ========================================
   WIDGET S♡LO V2 - STYLES
   ======================================== */
...
.solo-widget-trigger-icon .heart {
    color: var(--solo-or);
    display: inline;
}
...
.solo-option-badge {
    font-size: 0.65rem;
    background: var(--solo-or-light);
    color: var(--solo-taupe-dark);
    padding: 3px 8px;
    border-radius: 10px;
    font-family: 'Inter', -apple-system, sans-serif;
    font-weight: 600;
...
.solo-widget-separator {
    height: 1px;
    background: linear-gradient(90deg, transparent, var(--solo-taupe-light), transparent);
    opacity: 0.2;
    margin: 16px 0;
}
...
<button class="solo-widget-trigger" 
    ...
    <span class="solo-widget-trigger-icon">S<span class="heart">♡</span>lo</span>
</button>
...
<div class="solo-widget-panel" 
    ...
    <header class="solo-widget-header">
        <div class="solo-widget-avatar">S<span class="heart">♡</span>lo</div>
...
<script>
/**
 * Widget S♡lo V2 - Logique JavaScript
 */
(function() {
    'use strict';
    ...
    console.log('✓ Widget S♡lo V2 chargé — Soloplugs');
})();
</script>
<!-- Fin Widget S♡lo V2 -->
