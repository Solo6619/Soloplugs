  ...
  <main class="article-container">
    ...
    <header class="article-header">
      <div class="article-meta">
        ...
        <span class="article-date">6 décembre 2025</span>
        <span class="article-read">5 min de lecture</span>
      </div>
      ...
      <div class="related-grid">
        ...
        <a href="apprivoiser-le-silence.php" class="related-card">
          <div class="related-image">
            <img src="../images/Magazine/Solitude_silencieuse_02.jpg" alt="Apprivoiser le silence du dimanche" loading="lazy">
          </div>
