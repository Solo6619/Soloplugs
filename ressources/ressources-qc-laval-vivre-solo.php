...
<title>Ressources Laval — Vivre Solo | SOLOPLUGS</title>
...
@media (max-width: 640px) {
  ...
  .btn-retour { top: 16px; left: 16px; width: 44px; height: 44px; }
...
<div class="main-wrap">
  ...
  <div class="category-section" id="sante">
    <div class="category-header">
      ...
      <h2>Santé mentale et bien-être</h2>
      <span class="count">Ressources provinciales</span>
    </div>
    <div class="card-grid">
      <div class="resource-card" data-cat="sante">
        <div class="card-dot" style="background: var(--accent-rose);"></div>
        <div class="card-body">
          <h3>Info-Social 811</h3>
          <p class="card-desc">Service de consultation téléphonique psychosociale 24/7. Écoute, évaluation, référence vers les services appropriés.</p>
          <div class="card-meta">
            <span class="card-tag phone">811 (option 2)</span>
      ...
      <div class="resource-card" data-cat="sante">
        ...
        <div class="card-body">
          <h3>Tel-Aide</h3>
          <p class="card-desc">Écoute téléphonique anonyme et confidentielle pour toute détresse émotionnelle. Solitude, anxiété, dépression.</p>
          <div class="card-meta">
            <span class="card-tag phone">1-877-700-2433</span>
      ...
      <div class="resource-card" data-cat="sante">
        ...
        <div class="card-body">
          <h3>Phobies-Zéro</h3>
          <p class="card-desc">Soutien pour les personnes souffrant d'anxiété, de phobies, de TOC. Groupes d'entraide, ligne d'écoute.</p>
          <div class="card-meta">
            <span class="card-tag phone">1-866-922-0002</span>
            <span class="card-tag">phobies-zero.qc.ca</span>
            <span class="card-tag scope">Provincial</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
      ...
      <div class="resource-card" data-cat="sante">
        <div class="card-dot" style="background: var(--accent-rose);"></div>
        <div class="card-body">
          <h3>Relief — Dépression et bipolarité</h3>
          <p class="card-desc">Aide pour vivre avec l'anxiété, la dépression ou la bipolarité. Ateliers, groupes d'entraide, accompagnement.</p>
          <div class="card-meta">
            <span class="card-tag">monrelief.ca</span>
            <span class="card-tag scope">Provincial</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
  ...
  <div class="category-section" id="logement">
    ...
    <div class="card-grid">
      <div class="resource-card" data-cat="logement">
        ...
        <div class="card-body">
          <h3>Tribunal administratif du logement (TAL)</h3>
          <p class="card-desc">Information sur les droits et obligations des locataires et propriétaires. Règlement des litiges.</p>
          <div class="card-meta">
            <span class="card-tag phone">1-800-683-2245</span>
            <span class="card-tag">tal.gouv.qc.ca</span>
            <span class="card-tag scope">Provincial</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
      ...
      <div class="resource-card" data-cat="logement">
        <div class="card-dot" style="background: var(--accent-green);"></div>
        <div class="card-body">
          <h3>SHQ — Société d'habitation du Québec</h3>
          <p class="card-desc">Programmes d'aide au logement : allocation-logement, AccèsLogis, supplément au loyer.</p>
          <div class="card-meta">
            <span class="card-tag phone">1-800-463-4315</span>
            <span class="card-tag">habitation.gouv.qc.ca</span>
            <span class="card-tag scope">Provincial</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
  ...
  <div class="category-section" id="finances">
    ...
    <div class="card-grid">
      <div class="resource-card" data-cat="finances">
        ...
        <div class="card-body">
          <h3>ACEF — Associations coopératives d'économie familiale</h3>
          <p class="card-desc">Consultation budgétaire gratuite, éducation financière, aide aux consommateurs endettés.</p>
          <div class="card-meta">
            <span class="card-tag">consommateur.qc.ca</span>
            <span class="card-tag scope">Provincial</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
      ...
      <div class="resource-card" data-cat="finances">
        <div class="card-dot" style="background: var(--accent-amber);"></div>
        <div class="card-body">
          <h3>Office de la protection du consommateur</h3>
          <p class="card-desc">Information sur les droits des consommateurs, plaintes, médiation.</p>
          <div class="card-meta">
            <span class="card-tag phone">1-888-672-2556</span>
            <span class="card-tag">opc.gouv.qc.ca</span>
            <span class="card-tag scope">Provincial</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
    ...
    <div class="card-grid">
      <div class="resource-card" data-cat="securite">
        ...
        <div class="card-body">
          ...
          <p class="card-desc">Aide confidentielle 24/7 pour personnes victimes ou témoins de violence conjugale.</p>
          <div class="card-meta">
            <span class="card-tag phone">1-800-363-9010</span>
            <span class="card-tag scope">Provincial — 24/7</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
      ...
      <div class="resource-card" data-cat="securite">
        <div class="card-dot" style="background: var(--accent-slate);"></div>
        <div class="card-body">
          <h3>CAVAC — Centres d'aide aux victimes d'actes criminels</h3>
          <p class="card-desc">Aide gratuite et confidentielle pour toute personne victime d'un acte criminel.</p>
          <div class="card-meta">
            <span class="card-tag phone">1-866-532-2822</span>
      ...
      <div class="resource-card" data-cat="securite">
        ...
        <div class="card-body">
          ...
          <p class="card-desc">Écoute et référence pour personnes aînées victimes de maltraitance ou leurs proches.</p>
          <div class="card-meta">
  ...
  <div class="category-section" id="droits">
    <div class="category-header">
      <div class="category-indicator" style="background: var(--accent-teal-light);">
        <svg viewBox="0 0 24 24" fill="none" stroke="var(--accent-teal)" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>
      </div>
      <h2>Droits et services juridiques</h2>
      <span class="count">Ressources provinciales</span>
    </div>
    <div class="card-grid">
      <div class="resource-card" data-cat="droits">
        ...
        <div class="card-body">
          <h3>Éducaloi</h3>
          <p class="card-desc">Information juridique gratuite et vulgarisée sur de nombreux sujets : logement, famille, travail, consommation.</p>
          <div class="card-meta">
            <span class="card-tag">educaloi.qc.ca</span>
            <span class="card-tag scope">Provincial</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
      ...
      <div class="resource-card" data-cat="droits">
        <div class="card-dot" style="background: var(--accent-teal);"></div>
        <div class="card-body">
          <h3>Centres de justice de proximité</h3>
          <p class="card-desc">Information juridique gratuite et accompagnement pour comprendre vos droits et options.</p>
          <div class="card-meta">
      ...
      <div class="resource-card" data-cat="droits">
        <div class="card-dot" style="background: var(--accent-teal);"></div>
        <div class="card-body">
          <h3>Commission des droits de la personne et des droits de la jeunesse</h3>
          <p class="card-desc">Protection contre la discrimination, le harcèlement et l'exploitation.</p>
          <div class="card-meta">
            <span class="card-tag phone">1-800-361-6477</span>
            <span class="card-tag">cdpdj.qc.ca</span>
            <span class="card-tag scope">Provincial</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
  ...
  <div class="category-section" id="sociale">
    <div class="category-header">
      ...
      <h2>Vie sociale et communautaire</h2>
      <span class="count">Ressources provinciales</span>
    </div>
    <div class="card-grid">
      <div class="resource-card" data-cat="sociale">
        ...
        <div class="card-body">
          <h3>Réseau FADOQ</h3>
          <p class="card-desc">Le plus grand réseau de personnes de 50 ans et plus au Québec. Activités, voyages, défense des droits, rabais.</p>
          <div class="card-meta">
            <span class="card-tag phone">1-800-828-3344</span>
            <span class="card-tag">fadoq.ca</span>
            <span class="card-tag scope">Provincial</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
      ...
      <div class="resource-card" data-cat="sociale">
        <div class="card-dot" style="background: var(--accent-blue);"></div>
        <div class="card-body">
          <h3>Réseau des bibliothèques publiques</h3>
          <p class="card-desc">Clubs de lecture, conférences, ateliers, animations. Lieux importants de socialisation gratuite.</p>
          <div class="card-meta">
    ...
    <div class="card-grid">
      <div class="resource-card" data-cat="entraide">
        ...
        <div class="card-body">
          ...
          <p class="card-desc">Accompagnement à long terme pour personnes aînées isolées : visites, appels d'amitié, activités.</p>
          <div class="card-meta">
      ...
      <div class="resource-card" data-cat="entraide">
        ...
        <div class="card-body">
          ...
          <p class="card-desc">Accompagnement-transport, visites amicales, aide aux courses. Présents dans chaque MRC.</p>
          <div class="card-meta">
            <span class="card-tag">fcabq.org</span>
            <span class="card-tag scope">Provincial</span>
          </div>
        </div>
        <svg class="card-arrow" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"/></svg>
