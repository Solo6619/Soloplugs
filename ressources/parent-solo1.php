...
<main class="ressources-content">
  ...
  <section class="ressources-section">
    ...
    <article class="ressource-card">
      <span class="ressource-type">Webconférence</span>
      <h3 class="ressource-title">Parentalité & numérique, c'est la rentrée des classes !</h3>
      <p class="ressource-description">
        Cette rencontre aborde la place des écrans dans la vie familiale, autant pour les enfants que pour les adultes. On y parle de limites, d'exemplarité et de dialogue, avec des pistes concrètes pour poser le téléphone à certains moments clés (repas, coucher) sans viser la perfection, mais en retrouvant un peu de présence mutuelle.
      </p>
    </article>
    ...
    <article class="ressource-card">
      ...
      <p class="ressource-description">
        Pensée pour des parents qui se sentent dépassés par le numérique, elle propose des repères simples pour accompagner les usages des enfants et regarder aussi ses propres automatismes. Utile pour ouvrir une réflexion douce sur la manière dont, en tant que parent (et encore plus en solo), on peut apprivoiser son téléphone pour qu'il redevienne un outil, et non un refuge permanent.
      </p>
    </article>
